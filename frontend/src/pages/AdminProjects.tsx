    ...
    <div className="flex-1 bg-dash-bg py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 tracking-tight">Global Projects</h1>
            <p className="text-gray-500 mt-2 text-lg">Monitor all active projects across the platform.</p>
          </div>
                  ...
                  <tr key={project.id} className="hover:bg-gray-50/80 transition-colors group">
                    <td className="px-6 py-4">
                      ...
                      <div className="text-gray-500 mt-1 flex flex-col gap-1 text-xs">
                        ...
                        <span>Manager: <span className="font-medium text-gray-700">{project.manager || 'None'}</span></span>
                      </div>
                    </td>
